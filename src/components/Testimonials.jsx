...
const Testimonials = () => {
    ...
    return (
        <section id='testimonials' className="max-w-[1400px] mx-auto md:h-auto lg:h-[650px] relative overflow-hidden">
            ...
            <div className="flex flex-col pt-16 items-center relative pb-30 md:pb-30 lg:pr-0 px-4">
                {/* Header Text */}
                <header className="md:translate-x-40 lg:translate-x-15 text-center w-full max-w-2xl">
                ...
                {/* Carousel Border Box */}
                <div className="border z-10 border-sharp-pink rounded-3xl w-full translate-x-3 lg:translate-x-20 max-w-[320px] h-[370px] sm:max-w-[580px] sm:max-h-[360px] md:max-w-[470px] md:h-[320px] lg:max-w-[580px] lg:h-[300px] xl:max-w-[650px] xl:h-[320px] md:translate-x-35 translate-y-3 relative">
                        ...
                        <div className="relative h-full w-full">
                            {slides.map((slide, index) => (
                                ...
                                >
                                    ...
                                    <footer className='flex justify-between items-end w-full pb-8 md:pb-0'>
                                        <div className='flex gap-3 md:gap-5 items-center'>
                                            ...
                                            <div className='flex flex-col gap-1 -translate-y-4 sm:translate-y-2 md:-translate-y-4'>
                                                <cite className="font-Schotis-Bold md:text-lg sm:text-lg text-sm text-gray-900 leading-tight not-italic">
                                                    {slide.name}
                                                </cite>
                                                ...
                                                <div className='flex gap-0.5' aria-label="5 star rating">
                                                    {[...Array(5)].map((_, i) => (
                                                        <img key={i} className='h-3 md:h-3 sm:h-4' src="star1.svg" alt="" aria-hidden="true" />
                                                    ))}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        {/* Quote Icon SVG */}
                                        <div className="opacity-10 hidden md:block" aria-hidden="true">
                ...
                {/* Doodle Image */}
                <figure className="absolute right-10 -bottom-25 z-30 hidden lg:block xl:-translate-y-4 xl:-translate-x-8">
                    <img className="w-60 h-60 xl:w-65 xl:h-65 object-contain" src="/images/section6/doodle.png" alt="" />
                </figure>
            </div>
        </section>
    );
