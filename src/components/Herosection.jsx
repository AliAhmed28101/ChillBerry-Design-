...
const SocialIcons = () => (
    <div className='flex gap-3 items-center'>
        <a href="linkedin" aria-label="LinkedIn" className="text-black hover:text-sharp-pink transition-colors">
        ...
        <a href="facebook" aria-label="Facebook" className="text-black hover:text-sharp-pink transition-colors">
        ...
        <a href="instagram" aria-label="Instagram" className="text-black hover:text-sharp-pink transition-colors">
                ...
                <section className='hidden md:flex flex-row items-center justify-between
                    ...
                    <div className='relative flex-shrink-0
                        ...
                        <div className='relative z-10 pl-0 md:pl-2 lg:pl-10 xl:pl-16 pt-4 md:pt-0 lg:pt-8 lg:-translate-y-45 xl:-translate-y-73 '>
                            ...
                            <nav className='flex gap-1.5 md:gap-2 lg:gap-3 xl:gap-4 mt-6 md:mt-7 lg:mt-10 xl:mt-22' aria-label="Flavor selection">
                                {items.map(item => (
                                    <button
                                        key={item.key}
                                        type="button"
