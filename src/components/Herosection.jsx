...
const SocialIcons = () => (
    <section className='flex gap-3 items-center'>
        <a href="linkedin" className="text-black hover:text-sharp-pink transition-colors">
            <svg className="h-3.5 w-3.5" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="facebook" className="text-black hover:text-sharp-pink transition-colors">
            <svg className="h-3.5 w-3.5" viewBox="-5 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        ...
        <a href="instagram" className="text-black hover:text-sharp-pink transition-colors">
                ...
                <div className='flex flex-col items-center text-center md:hidden px-5 pt-8 pb-12 gap-4'>
                    ...
                    */}
                    <div className='relative bg-light-cement rounded-[40px] mx-auto mt-2
                        ...
                        <img
                            src={images["box1"]}
                            alt="Twist Temptation"
                            className='absolute -bottom-5 sm:-bottom-6 left-1/2 -translate-x-1/2
                                       w-[100%] sm:w-[95%] object-contain'
                        />

                        <div className="absolute bottom-0 right-0 translate-x-[28%] sm:translate-x-[20%] translate-y-[30%]
                    ...
                    {/* spacer so the social card overflow isn't clipped by parent gap */}
                    <div className='h-7' />
                    ...
                    >
                        View Menu
                        <img className="h-2.5 invert" src="next.svg" alt="next" />
                    </button>
                </div>
                                ...
                                {items.map(item => (
                                    <div
                                        ...
                                        className={`flex flex-col justify-center items-center rounded-2xl lg:rounded-3xl cursor-pointer
                                                    ...
                                                    transition-all
                                                    ${ActiveItem === item.key ? "bg-white shadow-sm" : ""}`}
                                    >
                                        <img className={item.imgClass} src={images[item.key]} alt={item.key} />
                                        <div className='font-Mazzard-Regular text-gray-800 whitespace-pre-line text-center
                        ...
                        <div className='relative bg-light-cement 
                            ...
                            <img
                                ...
                                className='absolute bottom-0 md:-bottom-2 left-1/2 -translate-x-1/2
                                           w-[90%]  md:w-[82%] lg:w-[90%] xl:w-[95%] md:translate-y-7
                                           object-contain
