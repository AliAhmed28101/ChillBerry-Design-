...
const Contactus = () => {
    ...
    return (
        ...
        <div className='maincontainer relative flex flex-col h-187 w-full overflow-hidden'>
            ...
            <div className='startingcontent flex flex-col  w-full z-20 h-50'>
                ...
                <div className='startingcontent flex flex-col items-center py-16 w-full h-50 '>
                ...
                <div className='contactscontainer w-390  flex  gap-4 py-7 px-50'>
                    ...
                    <div className='flex flex-col text-white h-full  z-20'>
                    ...
                    <div class="rotate-90 whitespace-nowrap flex items-center justify-center">
                    ...
                    <div className='flex flex-col gap-2  text-white h-full z-20'>
            ...
            <div className='mapandform flex gap-5 z-20 py-40 px-50 w-full'>
                ...
                <form onSubmit={handleSubmit} className='form flex flex-col text-white  w-127 gap-4 h-77 rounded-2xl bg-black/50 backdrop-blur-xs'>
                    ...
                    <div className='flex px-12 gap-7 py-8 pb-0 '>
                        ...
                        <div className='Name  border border-white/40 rounded-[7px] w-50 flex '>
                        ...
                        <div className='Phone border border-white/40 rounded-[7px] w-50 flex'>
                    ...
                    <div className='flex px-12 gap-7'>
                        ...
                        <div className='Email border border-white/40 rounded-[7px] w-50 flex '>
                        ...
                        <div className='Subject border border-white/40 rounded-[7px] w-50 flex relative items-center bg-transparent'>
